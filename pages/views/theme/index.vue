        ...
        <el-card class="box-card">
            <div slot="header">
                ...
                <a class='link-type link-title' target="_blank"
                   href='https://panjiachen.github.io/vue-element-admin-site/#/theme'>换肤文档</a>
            </div>
            <div class="box-item">
...
<script>
    import {toggleClass} from '~/pages/utils'
    import '~/pages/assets/custom-theme/index.css' // 换肤版本element-ui css
