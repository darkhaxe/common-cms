                    ...
                    <div style="height:100px;">
                        <el-form :model="demo" :rules="demoRules">
                            <el-form-item prop="title">
                                <md-input icon="search" name="title" placeholder="输入标题" v-model="demo.title">标题
                                </md-input>
                            </el-form-item>
                        </el-form>
                    </div>
...
<script>
    import PanThumb from '~/pages/components/PanThumb'
    import MdInput from '~/pages/components/MDinput'
    import Mallki from '~/pages/components/TextHoverEffect/Mallki'
    import DropdownMenu from '~/pages/components/Share/dropdownMenu'
    import waves from '~/pages/directive/waves/index.js' // 水波纹指令
