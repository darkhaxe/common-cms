...
<script>
    import {fetchList, fetchPv} from '~/pages/api/article'
    import waves from '~/pages/directive/waves/index.js' // 水波纹指令
    import {parseTime} from '~/pages/utils'
    ...
    export default {
        ...
        methods: {
            ...
            handleDownload() {
                require.ensure([], () => {
                    const {export_json_to_excel} = require('~/pages/vendor/Export2Excel');
